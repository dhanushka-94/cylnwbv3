    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="https://wa.me/971522306476" target="_blank" rel="noopener noreferrer"
            ...
            <div class="space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl p-6">
                        ...
                        <p class="text-gray-400 text-sm">Mobile / WhatsApp: <a href="https://wa.me/971522306476" target="_blank" rel="noopener noreferrer" class="text-[#f59e0b] hover:underline">+971 52 230 6476</a></p>
                    </div>
                </div>
                <!-- Email (shared) -->
