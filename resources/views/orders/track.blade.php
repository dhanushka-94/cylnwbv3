...
@section('title', 'Track Your Order - Ceylon IT Solutions')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-[#1c1c1e] rounded-xl border border-gray-800/30 p-8 mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Real-time tracking for your Ceylon IT Solutions order</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="e.g., CTS-2024-001234"
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-300 text-sm">
                            All Ceylon IT Solutions orders are shipped via <strong>Prompt Xpress</strong> courier service. 
        ...
        <div class="mt-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="mailto:info@ceylonitsolutions.com" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    info@ceylonitsolutions.com
                </a>
                <a href="https://wa.me/971522306476" target="_blank" class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg transition-colors">
