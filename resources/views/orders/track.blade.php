    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="https://wa.me/{{ config('bank.whatsapp_payment_number') }}" target="_blank" class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg transition-colors">
