...
class SmaProduct extends Model
{
    ...
    public function getMainImageAttribute()
    {
        if ($this->image) {
            ...
            return 'https://erp.ceylonitsolutions.com/assets/uploads/' . $this->image;
        }
        ...
        if ($firstPhoto) {
            ...
            return 'https://erp.ceylonitsolutions.com/assets/uploads/' . $firstPhoto->photo;
        }
    ...
    public function getImagesAttribute()
    {
        ...
        if ($this->image) {
            if (str_starts_with($this->image, 'http')) {
                ...
                $images[] = 'https://erp.ceylonitsolutions.com/assets/uploads/' . $this->image;
            }
        }
        ...
        foreach ($this->photos as $photo) {
            if (str_starts_with($photo->photo, 'http')) {
                ...
                $images[] = 'https://erp.ceylonitsolutions.com/assets/uploads/' . $photo->photo;
            }
        }
